...
class LayoutMainRightManager(
    ...
    private fun initParams(params: WindowManager.LayoutParams) {
        ...
        mParams?.x = (params.x - (context.resources.getDimension(R.dimen.margin).toInt() - cos(30.0) * context.resources.getDimension(R.dimen.margin).toInt())).toInt()
    ...
    override fun getRootViewId() = R.layout.layout_floating_main_right
