...
class LayoutRecordRightManager(
    context: Context?,
    ...
    private fun initParams(params: WindowManager.LayoutParams) {
        ...
        mParams?.x = (params.x - context.resources.getDimension(R.dimen.margin) as Int)
    ...
    override fun getRootViewId() = R.layout.layout_floating_recording_right
